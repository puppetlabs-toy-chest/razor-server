...
test_name 'Command - "create-repo" with positional arguments'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/587'

reset_database

razor agents, 'create-repo puppet-test-repo --url "http://provisioning.example.com/centos-6.4/x86_64/os/" --task centos' do |agent|
