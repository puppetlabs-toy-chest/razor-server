...
downloaded onto the Razor server:
  ...
  attr 'url', type: URI, exclude: 'iso_url', size: 1..1000,
              help: _('The URL of the remote repository to use.')

  attr 'iso_url', type: URI, exclude: 'url', size: 1..1000, help: _(<<-HELP)
  ...
  def run(request, data)
    ...
    data["iso_url"] = data.delete("iso_url")
